...
public class KafkaConsumerConfig {
    ...
    @Value(value = "${autogenerated-order.topic.group.id}")
    private String generatedOrderGroupId;
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Return> returnKafkaListenerContainerFactory() {
        var factory = new ConcurrentKafkaListenerContainerFactory<String, Return>();
        factory.setConsumerFactory(returnConsumerFactory());
        return factory;
    }

    public ConsumerFactory<String, Return> generatedOrderConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
        props.put(ConsumerConfig.CLIENT_ID_CONFIG, "GeneratedOrderConsumer");
        props.put(ConsumerConfig.GROUP_ID_CONFIG, generatedOrderGroupId);
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        return new DefaultKafkaConsumerFactory<>(props);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Return> orderGeneratedKafkaListenerContainerFactory() {
        var factory = new ConcurrentKafkaListenerContainerFactory<String, Return>();
        factory.setConsumerFactory(generatedOrderConsumerFactory());
        return factory;
    }
}
