...
public class TopicConfig {
    ...
    @Value(value = "${autogenerated-order.topic.name}")
    private String generatedOrderTopicName;
    ...
    @Bean
    public NewTopic generatedOrderTopicName() {
        return TopicBuilder.name(generatedOrderTopicName)
                .partitions(1)
                .replicas(1)
                .build();
    }
